...
for tile_name in tile_list:
    ...
    resample_cmd = ['gdal_translate', '-r', 'nearest', '-tr', '.001', '.001', '-co', 'COMPRESS=LZW', extent_local, resample_tile]
    subprocess.check_call(resample_cmd)

    # mask tcd tile
    # here you can change tcd from --calc=A>30 to --calc=A>90. If not resampling, change "resample_tile" to "extent_local"
    ...
    if datasource is None:
        ...
        if featurecount > 0:
            ...
            file_to_remove.append(zipped_tile)
            file_to_remove = file_to_remove + merge_shape_list
            ...
            pass
    # clean directory
    files_to_remove = [resample_tile, extent_local, masked_tile_30]
